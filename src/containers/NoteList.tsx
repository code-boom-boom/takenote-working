...
import { addCategoryToNote, pruneNotes, searchNotes, swapCategory, swapNote } from 'slices/note'
import { RootState, NoteItem, ReactMouseEvent, ReactDragEvent } from 'types'
